...
To recreate the original tarball out of the parts in either split folder, navigate into the split folder and run this command: `cat part_* > llvm21.1.8.tar.xz`
